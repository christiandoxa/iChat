...
class Encryption {
    class func encryptText(chatRoomId: String, message: String) -> String {
        ...
        return encryptedData.base64EncodedString(options: NSData.Base64EncodingOptions(
                rawValue: 0))
    }
    ...
    class func decryptText(chatRoomId: String, encryptedMessage: String) -> String {
        ...
        let encryptedData = NSData(base64Encoded: encryptedMessage,
        ...
        if encryptedData != nil {
            do {
                ...
                message = NSString(data: decryptedData,
